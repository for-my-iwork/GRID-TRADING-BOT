...
class AIOptimizer:
    ...
    def get_optimized_parameters(self, price_history, session_duration):
        ...
        try:
            market_analysis = self.market_analyzer.multi_timeframe_analysis('BTCUSDT', price_history)
            ...
            optimized_duration = self.ai_optimize_session_duration(market_regime, session_duration)
    ...
    def ai_optimize_session_duration(self, market_regime, requested_duration):
        ...
        final_duration = max(MIN_SESSION_DURATION, min(MAX_SESSION_DURATION, final_duration))
