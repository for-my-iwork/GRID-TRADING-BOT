# core/grid_bot.py
"""
🤖 ОСНОВНОЙ КЛАСС GRID TRADING BOT v9.0
"""
...
class AdvancedGridBotV90:
    ...
    def __init__(self):
        ...
        print("✅ Бот v9.0 инициализирован с модульной архитектурой")
    ...
    def interactive_setup(self):
        ...
        print("\n🎮 ИНТЕРАКТИВНАЯ НАСТРОЙКА AI GRID BOT v9.0")
        print("=" * 50)
